...
$sql3 = "DELETE FROM history WHERE history.Stud_ID = {$_SESSION['user_id']} AND history.SemesterYearID = 50001 AND history.Sec_ID = '".$id."'";
$sql5 = "DELETE FROM enrollment1 WHERE enrollment1.Stud_ID = {$_SESSION['user_id']} AND enrollment1.E_SemesterYearID = 50001 AND enrollment1.E_Sec_ID = '".$id."'";
