...
/*
if ($_SESSION['Spring2023'] = '5004'){
    
$DateEnd = new DateTime('2022-09-20');
echo " Registration Ends " . $DateEnd->format('m/d/Y');
}
*/
$DateEnd = new DateTime('2023-02-10');
echo " Registration Ends " . $DateEnd->format('m/d/Y');
echo  $_SESSION['Spring2023'];
...
/*
if($_SESSION['Spring2023'] == '5001'){
    echo "Time to add expired";
}
*/
         $semyear = $_SESSION['Spring2023'];
         ...
         // $result = $alreadyin->fetchALL(PDO::FETCH_COLUMN,0);
          ...
          $timecheck = $conn->prepare("SELECT section.S_TimeSlotID FROM section JOIN history WHERE history.Stud_ID = {$_SESSION['user_id']} AND history.SemesterYearID = '50001' AND history.Sec_ID = section.S_Section_ID AND section.S_TimeSlotID = '".$id7."'");
          $timecheck->execute();
   ...
   if ($result = mysqli_query($conn, $sql)){
    ...
    $rownumber = $rownumber + 1;
      ...
      while($row = mysqli_fetch_array($result)){
        ...
        echo "<td><form method='POST' action='Businesscoursesearch.php'>"
